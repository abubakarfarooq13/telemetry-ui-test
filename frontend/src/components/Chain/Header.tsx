...
import blockIcon from '../../icons/phronai-block-white.png';
import finalizedIcon from '../../icons/layers-white.png';
import blockTimeIcon from '../../icons/phronai-last-block.png';
import lastTimeIcon from '../../icons/clock-white.png';
  ...
  public render() {
    ...
    return (
      ...
      <div className="header">
        ...
        <Tile icon={lastTimeIcon} title="Number of Sessions">
          #{formatNumber(best)}
        </Tile>
        ...
        {/* <Tile icon={blockIcon} title="Allocated era Sessions">
          #{formatNumber(best)}
        </Tile> */}
        <div className="Header-tabs">
          ...
          <Tab
            icon={verified}
            label="Validator Graph"
            display="validator graph"
            tab=""
            current={currentTab}
            setDisplay={setDisplay}
          />
