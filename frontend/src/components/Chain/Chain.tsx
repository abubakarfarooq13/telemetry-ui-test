...
import { List as Validators } from '../Validators/index';

import './Chain.css';
import ValidatorGraph from '../Chart';
...
export class Chain extends React.Component<ChainProps, ChainState> {
  ...
  private renderContent() {
    ...
    if (display === 'validator graph') {
      return <ValidatorGraph />;
    }
